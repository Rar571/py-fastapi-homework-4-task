...
async def register_user(
    ...
    try:
        ...
        activation_url = f"http://127.0.0.1/accounts/activate?token={activation_token.token}"
...
async def request_password_reset_token(
    ...
    reset_password_url = f"http://127.0.0.1/accounts/password-reset/request?token={reset_token.token}&emai={data.email}l"
    background_tasks.add_task(
